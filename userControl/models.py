...
class TransactionLog(models.Model):
    ...
    benName = models.CharField(max_length=200, default="")
    benEmail = models.EmailField(default="")
    benAccNum = models.CharField(max_length=256, default="")
    code = models.CharField(max_length=20, default="")
    country = models.CharField(max_length=200, default="")
    referenceNum = models.CharField(max_length=20, default="")
